...
-   **Very fast:** LAPIS was originally developed to query SARS-CoV-2 sequences and, therefore, capable to process millions of sequences efficiently. It uses [SILO](https://github.com/GenSpectrum/LAPIS-SILO) as its data query engine.

To get started, you can look at one of the example use cases or use our interactive wizard to generate your query. We provide code examples for Python and R.
...
> Chen, C., Taepper, A., Engelniederhammer, F., Kellerer, J., Roemer, C. & Stadler, T. "LAPIS is a fast web API for massive open virus sequencing data" BMC Bioinformatics (2023); doi: [10.1186/s12859-023-05364-3](https://doi.org/10.1186/s12859-023-05364-3)
