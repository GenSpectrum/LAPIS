...
public class NextcladeTsvEntry {
    ...
    public NextcladeTsvEntry setPangoLineage(String pangoLineage) {
    ...
    public NextcladeTsvEntry setTotalAminoacidSubstitutions(
        Integer totalAminoacidSubstitutions) {
    ...
    public NextcladeTsvEntry setQcMixedSitesTotalMixedSites(
        Integer qcMixedSitesTotalMixedSites) {
    ...
    public NextcladeTsvEntry setQcSnpClustersClusteredSNPs(
        String qcSnpClustersClusteredSNPs) {
    ...
    public NextcladeTsvEntry setQcFrameShiftsTotalFrameShifts(
        Integer qcFrameShiftsTotalFrameShifts) {
    ...
    public NextcladeTsvEntry setQcFrameShiftsFrameShiftsIgnored(
        String qcFrameShiftsFrameShiftsIgnored) {
    ...
    public NextcladeTsvEntry setQcFrameShiftsTotalFrameShiftsIgnored(
        Integer qcFrameShiftsTotalFrameShiftsIgnored) {
    ...
    public NextcladeTsvEntry setQcStopCodonsTotalStopCodons(
        Integer qcStopCodonsTotalStopCodons) {
