...
public class YMainAaSequenceRecord extends UpdatableRecordImpl<YMainAaSequenceRecord> implements Record3<Integer, String, byte[]> {
    ...
    /**
     * Setter for <code>y_main_aa_sequence.aa_seq_compressed</code>.
     */
    ...
    /**
     * Getter for <code>y_main_aa_sequence.aa_seq_compressed</code>.
     */
    ...
    public Field<byte[]> field3() {
        return YMainAaSequence.Y_MAIN_AA_SEQUENCE.AA_SEQ_COMPRESSED;
    }
    ...
    @Override
    public YMainAaSequenceRecord value3(byte[] value) {
        setAaSeqCompressed(value);
        return this;
    }

    @Override
    public YMainAaSequenceRecord values(Integer value1, String value2, byte[] value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public YMainAaSequenceRecord(Integer id, String gene, byte[] aaSeqCompressed) {
        super(YMainAaSequence.Y_MAIN_AA_SEQUENCE);
