...
public class YMainSequenceStagingRecord extends UpdatableRecordImpl<YMainSequenceStagingRecord> implements Record9<Integer, byte[], byte[], String, String, String, String, String, String> {
    ...
    @Override
    public Row9<Integer, byte[], byte[], String, String, String, String, String, String> valuesRow() {
    ...
    @Override
    public YMainSequenceStagingRecord values(Integer value1, byte[] value2, byte[] value3, String value4, String value5, String value6, String value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public YMainSequenceStagingRecord(Integer id, byte[] seqOriginalCompressed, byte[] seqAlignedCompressed, String aaMutations, String aaUnknowns, String nucSubstitutions, String nucDeletions, String nucInsertions, String nucUnknowns) {
        super(YMainSequenceStaging.Y_MAIN_SEQUENCE_STAGING);
