...
public class YMainSequenceStagingRecord extends UpdatableRecordImpl<YMainSequenceStagingRecord> implements Record7<Integer, byte[], byte[], String, String, String, String> {
    ...
    @Override
    public YMainSequenceStagingRecord values(Integer value1, byte[] value2, byte[] value3, String value4, String value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public YMainSequenceStagingRecord(Integer id, byte[] seqOriginalCompressed, byte[] seqAlignedCompressed, String aaMutations, String nucSubstitutions, String nucDeletions, String nucInsertions) {
        super(YMainSequenceStaging.Y_MAIN_SEQUENCE_STAGING);
