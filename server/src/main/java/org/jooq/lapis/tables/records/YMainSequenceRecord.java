...
public class YMainSequenceRecord extends UpdatableRecordImpl<YMainSequenceRecord> implements Record9<Integer, byte[], byte[], String, String, String, String, String, String> {
    ...
    @Override
    public YMainSequenceRecord values(Integer value1, byte[] value2, byte[] value3, String value4, String value5, String value6, String value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public YMainSequenceRecord(Integer id, byte[] seqOriginalCompressed, byte[] seqAlignedCompressed, String aaMutations, String aaUnknowns, String nucSubstitutions, String nucDeletions, String nucInsertions, String nucUnknowns) {
        super(YMainSequence.Y_MAIN_SEQUENCE);
