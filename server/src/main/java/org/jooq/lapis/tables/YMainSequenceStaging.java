...
public class YMainSequenceStaging extends TableImpl<YMainSequenceStagingRecord> {
    ...
    /**
     * The column <code>y_main_sequence_staging.aa_insertions</code>.
     */
    public final TableField<YMainSequenceStagingRecord, String> AA_INSERTIONS = createField(DSL.name("aa_insertions"), SQLDataType.CLOB, this, "");
    ...
    public List<UniqueKey<YMainSequenceStagingRecord>> getKeys() {
        return Arrays.<UniqueKey<YMainSequenceStagingRecord>>asList(Keys.Y_MAIN_SEQUENCE_STAGING_PKEY);
    }
