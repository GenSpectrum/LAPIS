...
const val PRINT_NODES_NOT_IN_TREE_FIELD_PROPERTY = "printNodesNotInTree"
const val PHYLO_TREE_FIELD_PROPERTY = "phyloTreeField"
const val POSITIONS_PROPERTY = "positions"
...
val SPECIAL_REQUEST_PROPERTY_TYPES = mapOf(
    ...
    SEGMENTS_PROPERTY to JsonNodeType.ARRAY,
    GENES_PROPERTY to JsonNodeType.ARRAY,
    FASTA_HEADER_TEMPLATE_PROPERTY to JsonNodeType.STRING,
    PRINT_NODES_NOT_IN_TREE_FIELD_PROPERTY to JsonNodeType.BOOLEAN,
    PHYLO_TREE_FIELD_PROPERTY to JsonNodeType.STRING,
    POSITIONS_PROPERTY to JsonNodeType.ARRAY,
)
