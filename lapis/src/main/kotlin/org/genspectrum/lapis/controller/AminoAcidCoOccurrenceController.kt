...
class AminoAcidCoOccurrenceController(
    ...
    @StringResponseOperation(
        ...
        operationId = "getAminoAcidCoOccurrenceAsCsv",
    )
    fun getAminoAcidCoOccurrenceAsCsv(
        @PathVariable(name = "gene", required = true)
        @Gene
        gene: String,
        @PrimitiveFieldFilters
    ...
    @StringResponseOperation(
        description = AMINO_ACID_CO_OCCURRENCE_ENDPOINT_DESCRIPTION,
        operationId = "getAminoAcidCoOccurrenceAsTsv",
    )
    fun getAminoAcidCoOccurrenceAsTsv(
        @PathVariable(name = "gene", required = true)
        @Gene
        gene: String,
        @PrimitiveFieldFilters
    ...
    @StringResponseOperation(
        description = AMINO_ACID_CO_OCCURRENCE_ENDPOINT_DESCRIPTION,
        operationId = "postAminoAcidCoOccurrenceAsCsv",
    )
    fun postAminoAcidCoOccurrenceAsCsv(
        @PathVariable(name = "gene", required = true)
        @Gene
        gene: String,
        @RequestBody
    ...
    @StringResponseOperation(
        description = AMINO_ACID_CO_OCCURRENCE_ENDPOINT_DESCRIPTION,
        operationId = "postAminoAcidCoOccurrenceAsTsv",
    )
    fun postAminoAcidCoOccurrenceAsTsv(
        @PathVariable(name = "gene", required = true)
        @Gene
        gene: String,
        @RequestBody
