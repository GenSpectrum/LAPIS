...
LAPIS supports optional OAuth 2.0 authentication - and thus also OpenID Connect (OIDC) - to protect your API endpoints.
...
Also see https://docs.spring.io/spring-security/reference/servlet/oauth2/resource-server/jwt.html for further details.
